...
> [!NOTE]
> No es necesario que entendáis todavía cómo funciona `matches` ni otros elementos de la sintaxis en detalle. De momento, usad estos métodos como una herramienta ya construida: os dicen `true` o `false` según si el texto es válido.
